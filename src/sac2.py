...
class SAC(OffPolicyRLModel):
    ...
    def __init__(self, policy, env, gamma=0.99, learning_rate=3e-4, buffer_size=50000, full_size = 1000000,
    ...
    def setup_model(self):
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                self.full_buffer   = FullBuffer(self.full_size, self.env.observation_space.shape[0], self.env.action_space.shape[0])
    ...
    def learn(self, total_timesteps, callback=None,
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            for step in range(total_timesteps):
                ...
                trajectory.append(Experience(obs_, action, new_obs_, reward_, float(done)))
                obs = new_obs
