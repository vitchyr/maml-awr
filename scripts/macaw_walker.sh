...
which python
python -m run --name $1 --log_dir $2 --advantage_head_coef 0.1 --device cuda:0 --task_config config/walker_params/50tasks_offline_iris.json --offline --load_inner_buffer --load_outer_buffer --replay_buffer_size 2000000 --outer_value_lr 1e-3 --outer_policy_lr 1e-3 --batch_size 256 --inner_batch_size 16 --maml_steps $3
